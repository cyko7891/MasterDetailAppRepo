sap.ui.define([
		...
		opaTest("MasterList Filtering on ProductID less than 100", function(Given, When, Then) {

			// Action
			When.onTheMasterPage.iOpenViewSettingsDialog().
				and.iSelectListItemInViewSettingsDialog("ProductID").
		...
		opaTest("MasterList Filtering on ProductID more than 100", function(Given, When, Then) {
			// Action
			When.onTheMasterPage.iOpenViewSettingsDialog().
				and.iSelectListItemInViewSettingsDialog(">100 UnitPrice").
				and.iPressOKInViewSelectionDialog();
