sap.ui.define([
		...
		return BaseObject.extend("manageproducts.model.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias manageproducts.model.ListSelector
			 */
			 ...
			 * @return {manageproducts.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
