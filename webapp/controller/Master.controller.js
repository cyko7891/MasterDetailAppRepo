/*global history */
sap.ui.define([
		"manageproducts/controller/BaseController",
		...
		"sap/ui/Device",
		"manageproducts/model/formatter",
		"manageproducts/model/grouper",
		...
		return BaseController.extend("manageproducts.controller.Master", {
			...
			onOpenViewSettings : function () {
				if (!this._oViewSettingsDialog) {
					this._oViewSettingsDialog = sap.ui.xmlfragment("manageproducts.view.ViewSettingsDialog", this);
