sap.ui.define([
	...
	return BaseObject.extend("manageproducts.model.GroupSortState", {
		 ...
		 * @alias manageproducts.model.GroupSortState
		 */
		...
		/**
		 * Sorts by ProductName, or by ProductID
		 *
		...
		/**
		 * Groups by ProductID, or resets the grouping for the key "None"
		 *
		 * @param {string} sKey - the key of the field used for grouping
		 * @returns {sap.ui.model.Sorter[]} an array of sorters
		 */
